          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <FormControl>
                  <SelectTrigger>
                    <SelectValue placeholder="Selecciona el tipo del ticket" />
                  </SelectTrigger>
                </FormControl>
                <SelectContent>
                  <SelectItem value="tipo 1">1</SelectItem>
                  <SelectItem value="tipo 2">2</SelectItem>
                  <SelectItem value="tipo 3">3</SelectItem>
                  <SelectItem value="tipo ...">...</SelectItem>
                </SelectContent>
              </Select>
              <FormDescription>
                Seleccione el tipo de tu ticket.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
